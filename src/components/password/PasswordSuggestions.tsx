      ...
      <div className="flex items-center justify-between">
        ...
        {isComplete && (
          <motion.span
            ...
            className="text-success flex items-center gap-1 text-xs font-bold tracking-wide"
          >
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {isComplete && (
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-success bg-success/5 border-success/20 w-full rounded-xl border px-4 py-2 text-center text-sm font-bold"
          >
