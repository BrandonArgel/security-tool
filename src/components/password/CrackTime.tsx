    ...
    <Card variant="ghost" padding="sm" className={cn(crackTimeVariants({ level }))}>
      <div className="flex items-start justify-between">
        <div className="flex flex-col">
          <span className="text-sm font-bold tracking-wide opacity-70">Time to Crack (2026 Est.)</span>

          <span className="mt-1 text-xl leading-none font-black tracking-tight">{time}</span>
        </div>

        <div className="shrink-0 text-right">
          <span className="block font-mono text-sm opacity-60">Brute Force Rate</span>
